...
namespace FlaUI.Core.AutomationElements
{
    ...
    public partial class AutomationElement : IEquatable<AutomationElement>, IAutomationElementEventSubscriber
    {
        ...
        /// <summary>
        /// Compares the current element with the image from specified file path.
        /// If the snapshot of the current element differs from the image in the file then an exception is thrown.
        ...
        public void ImageAssert(string filePath)
        {
            ...
            if (progManaged != null)
            {
                ...
                if (desktopList != null)
                {
                    ...
                    // we want to capture the element without focus. controls and windows look different when they have the focus (on edit control a caret may appear and so on).
                    desktopList.SetFocus();
                    System.Threading.Thread.Sleep(300);
                }
            }
            
            Bitmap crtBitmap = this.Capture();
