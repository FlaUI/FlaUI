...
namespace FlaUI.Core.AutomationElements
{
    public class Thumb : AutomationElement
    {
        ...
        {
            Mouse.DragHorizontally(MouseButton.Left, Information.BoundingRectangle.Center, distance);
        }
        ...
        {
            Mouse.DragVertically(MouseButton.Left, Information.BoundingRectangle.Center, distance);
        }
    }
}
