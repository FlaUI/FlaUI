...
namespace FlaUI.Core.AutomationElements
{
    public class Thumb : AutomationElement
    {
        ...
        {
            Mouse.DragHorizontally(MouseButton.Left, Info.BoundingRectangle.Center, distance);
        }
        ...
        {
            Mouse.DragVertically(MouseButton.Left, Info.BoundingRectangle.Center, distance);
        }
    }
}
