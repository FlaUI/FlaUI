...
namespace FlaUI.Core
{
    ...
    public class Application : IDisposable
    {
        ...
        public static Application Launch(string executable, string cParams = null)
        {
            var processStartInfo = new ProcessStartInfo(executable);
            return Launch(processStartInfo, cParams);
        }
        ...
        public static Application Launch(ProcessStartInfo processStartInfo, string cParams = null)
        {
            ...
            try
            {
                process = Process.Start(processStartInfo, cParams);
            }
